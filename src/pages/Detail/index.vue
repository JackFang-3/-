        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 这里再加入购物车路由跳转之前，将购买产品的信息通过请求通知服务器，服务器进行相应存储 -->
    ...
    methods: {
      ...
      async addShopCart(){
        ...
        try {
          ...
          // 进行路由跳转   this.$router.push({name:'addcartsuccess',query:{skuInfo:this.skuInfo,skuNum:this.skuNum}})
          // 简单的数据 skuNum直接通过路由传过去
          // 像skuInfo要通过会话存储【】
          // 本地存储|会话存储一般存储字符串
